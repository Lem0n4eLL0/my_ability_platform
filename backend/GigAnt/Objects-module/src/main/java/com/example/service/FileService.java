...
@Service
public class FileService implements com.example.service.FileStorage {

  @Autowired
  FileManager fileManager;
  @Autowired
  com.example.service.FileServiceStorage fileServiceStorage;
  @Autowired
  FileRepository fileRepository;
  @Autowired
  private com.example.service.MultiPartFileToDTO multiPartFileToDTO;
  @Autowired
  MediaMapper mapper;
