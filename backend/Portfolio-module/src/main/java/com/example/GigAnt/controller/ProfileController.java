...
public class ProfileController {
    ...
    @PostMapping("/profile")
    public ResponseEntity<ProfileResponse> createProfile(@Validated @RequestBody ProfileCreateRequest request,
    ...
    @PatchMapping("/me")
    public ResponseEntity<ProfileResponse> updateProfile(@Validated @RequestBody ProfileUpdateRequest request,
                                                         @RequestAttribute(ACCOUNT_ID) @NotNull UUID accountId) {
